...
vtkStandardNewMacro(liggghts_reader_gz);
...
liggghts_reader_gz::liggghts_reader_gz()
{
	this->FileName = 0;
	this->File = 0;
...
void liggghts_reader_gz::OpenFile()
{
	if (!this->FileName)
	{
...
int liggghts_reader_gz::RequestData(vtkInformation *request, vtkInformationVector **inputVector, vtkInformationVector *outputVector)
{
...
int liggghts_reader_gz::RequestInformation(
...
void liggghts_reader_gz::PrintSelf(ostream& os, vtkIndent indent)
{
...
int liggghts_reader_gz::CanReadFile(const char *fname)
{
	return 1;
}
